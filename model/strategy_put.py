...
def skew_arbitrage_put(start_date=20200226, end_date=20210330):
    R = 0.02
    option_string = '510050.SH'
    data_path = r"E:\XX\option_arbitrage\data\mid\csv\skew_put_up_middle_low.csv"
    ...
    pdb.set_trace()
    open_close_df.to_csv(r'E:\XX\option_arbitrage\result\data\open_close_detail(put).csv')
    open_close_total_df.set_index(['trade_date'], inplace=True)
    open_close_total_df.to_csv(r'E:\XX\option_arbitrage\result\data\open_close_total(put).csv')
...
if __name__ == '__main__':
    # 采用偏度策略进行交易
    x1, y1 = skew_arbitrage_put(20200701, 20200901)
